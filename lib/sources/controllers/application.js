...
zz.environment.services.MVCTree.registry.setController( 'application', zz.mvc.controllers.Application );

/**
 * Here yours application start.
 */
zz.mvc.controllers.Application.prototype.enterDocument = function( ){
    ...
    var layoutModel = this.getModel( ).lastDatarow( ).layout;
