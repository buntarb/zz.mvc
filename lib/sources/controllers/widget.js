...
zz.mvc.controllers.Widget.prototype.renderScatterplotMatrix = function( widget ){
    ...
    var uid = this.getModel( ).getUid( ) + this.separator_ + widget.getUid( ) + this.separator_ + this.getModel( ).datafield.data;
...
zz.mvc.controllers.Widget.prototype.testHC = function( widget ){
    ...
    var chart = new window[ 'Highcharts' ][ 'Chart' ]( HCOptions, function( chart ){
        ...
        for( var i = 0; i < mvc.model.numberField; i++ ){
        ...
        mvc.model.title = mvc.model.title.split( this.separator_ )[ 0 ] + ': ' + (endTime - startTime) + ' ms.'
    } );
};
